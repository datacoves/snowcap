#!/bin/bash
# Plan static resources needed for integration tests (dry run)
...
echo "Planning static resources for integration tests..."
...
cd "$SCRIPT_DIR/../../.."
python -m snowcap plan --config tests/fixtures/static_resources/

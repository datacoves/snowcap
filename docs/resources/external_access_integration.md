...
[Snowflake Documentation](https://docs.snowflake.com/en/sql-reference/sql/create-external-access-integration) | Snowcap CLI label: `external_access_integration`
